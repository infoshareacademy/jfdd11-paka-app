      ...
      <br></br>
        ...
        <div>
          <Card>
            ...
            <div className='MyProfileText' style={{ display: 'flex', flexDirection: 'column', alignContent: 'space-between', width: '80vw', margin: '0 auto'}}>
             <div><p>Age: </p> <span>{this.state.age}</span></div>
              ...
              <div><p><FontAwesomeIcon icon={faHome} /> {' '}House-sitting at the dog-owner place:</p> <span>{this.state.houseSittingAtYourPlace ? <FontAwesomeIcon icon={faCheck} /> : <FontAwesomeIcon icon={faTimes} />}</span></div>
